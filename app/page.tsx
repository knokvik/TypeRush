...
export default function Home() {
  ...
  /**
   * Handles game joining by emitting invite code via socket
   */
  ...
  /**
   * Creates a new game and navigates to the game page with unique code
   */
  function createGame() {
  ...
  /**
   * Displays a hint message to guide users
   */
  function getStarted() {
  ...
  return (
    ...
    <main className="w-full mx-auto max-w-7xl fade-in-down">
      ...
      <section className="pt-[5rem] h-[32rem] xl:h-[40rem] lg:h-[40rem] w-full rounded-md flex flex-col  md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        ...
        <div className=" p-4 max-w-7xl mx-auto relative z-10 w-full pt-20  md:pt-0">
          <nav className="flex flex-col items-center gap-0 leading-none mb-10">
            ...
            <p className="my-8 text-lg text-center xl:text-2xl lg:text-2xl text-zinc-300 aos-init aos-animate"  data-aos-delay="200">Dont drown in notifications and keep your workspace focused</p>
            <div className="flex flex-row  items-center max-w-xs mx-auto gap-4 sm:max-w-none sm:justify-center sm:flex-row sm:inline-flex aos-init aos-animate" data-aos="fade-down" data-aos-delay="400">
              <a className=\" cursor-pointer w-full justify-center flex items-center whitespace-nowrap transition duration-150 ease-in-out font-medium rounded-xl px-4 py-3  text-zinc-900 bg-gradient-to-r from-white/80 via-white to-white/80 hover:bg-white group\" onClick={getStarted}>Get Started <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" strokeLinecap=\"round\" strokeLinejoin=\"round\" className=\"w-3 h-3 tracking-normal text-primary-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1 stroke-2\"><line x1=\"5\" x2=\"19\" y1=\"12\" y2=\"12\"></line><polyline points=\"12 5 19 12 12 19\"></polyline></svg></a>
      ...
      <nav className="flex flex-col px-5 xl:flex-row lg:flex-row justify-center md:items-center gap-10">
